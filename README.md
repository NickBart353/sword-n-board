...
- sword-n-board is the project name for this first person - action rpg.
- player is supposed to explore a world, slay creates and most importantly, collect loot.
- not sure if there will be a dedicated main-story/plot, environmental story-telling or just pure exploration.
